...
function generateNameQuestion()
{
    ...
    firstQuestion.innerText = "Port Number(s):";
}

function generatePortQuestion()
{
    nameQuestion = false;
    mainName.innerText = ports[questionNumber].port;
    firstQuestion.innerText = "Port Name:";
}
...
function gradeQuestion()
{
    ...
    if(nameQuestion)
    {
        if(firstInput.value.toLowerCase() == ports[questionNumber].port.toLowerCase() && secondInput.value.toLowerCase() == ports[questionNumber].transport.toLowerCase())
        {
            streak += 1;
        ...
        if(firstInput.value.toLowerCase() == ports[questionNumber].acronym.toLowerCase() && secondInput.value.toLowerCase() == ports[questionNumber].transport.toLowerCase())
        {
            submitButton.innerText = "Correct!";
            streak += 1;
            handleStreak();
